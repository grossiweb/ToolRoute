-- NeoSkill Migration 005: Expanded Skill Catalog
-- Adds 40+ real MCP servers to ensure 3+ per workflow category
-- Run in Supabase SQL Editor

-- ─────────────────────────────────────────────
-- NEW SKILLS — Developer Workflow
-- ─────────────────────────────────────────────
...
-- ─────────────────────────────────────────────
-- NEW SKILLS — Research & Intelligence
-- ─────────────────────────────────────────────
INSERT INTO skills (canonical_name, slug, repo_url, vendor_name, vendor_type, short_description, open_source, remote_available, local_available, status, featured, license) VALUES
...
-- ─────────────────────────────────────────────
-- NEW SKILLS — Knowledge Management
-- ─────────────────────────────────────────────
INSERT INTO skills (canonical_name, slug, repo_url, vendor_name, vendor_type, short_description, open_source, remote_available, local_available, status, featured, license) VALUES
...
-- ─────────────────────────────────────────────
-- NEW SKILLS — Data Analysis & Reporting
-- ─────────────────────────────────────────────
INSERT INTO skills (canonical_name, slug, repo_url, vendor_name, vendor_type, short_description, open_source, remote_available, local_available, status, featured, license) VALUES
...
-- ─────────────────────────────────────────────
-- NEW SKILLS — Sales Research & Outreach
-- ─────────────────────────────────────────────
INSERT INTO skills (canonical_name, slug, repo_url, vendor_name, vendor_type, short_description, open_source, remote_available, local_available, status, featured, license) VALUES
...
-- ─────────────────────────────────────────────
-- NEW SKILLS — Content Creation & Publishing
-- ─────────────────────────────────────────────
INSERT INTO skills (canonical_name, slug, repo_url, vendor_name, vendor_type, short_description, open_source, remote_available, local_available, status, featured, license) VALUES
...
-- ─────────────────────────────────────────────
-- NEW SKILLS — Marketing Intelligence
-- ─────────────────────────────────────────────
INSERT INTO skills (canonical_name, slug, repo_url, vendor_name, vendor_type, short_description, open_source, remote_available, local_available, status, featured, license) VALUES
...
-- ─────────────────────────────────────────────
-- NEW SKILLS — E-commerce Operations
-- ─────────────────────────────────────────────
INSERT INTO skills (canonical_name, slug, repo_url, vendor_name, vendor_type, short_description, open_source, remote_available, local_available, status, featured, license) VALUES
...
-- ─────────────────────────────────────────────
-- NEW SKILLS — Security Operations
-- ─────────────────────────────────────────────
INSERT INTO skills (canonical_name, slug, repo_url, vendor_name, vendor_type, short_description, open_source, remote_available, local_available, status, featured, license) VALUES
...
-- ─────────────────────────────────────────────
-- NEW SKILLS — Executive/Productivity
-- ─────────────────────────────────────────────
INSERT INTO skills (canonical_name, slug, repo_url, vendor_name, vendor_type, short_description, open_source, remote_available, local_available, status, featured, license) VALUES
...
-- ─────────────────────────────────────────────
-- SEED METRICS for all 42 new skills
-- ─────────────────────────────────────────────
...
-- ─────────────────────────────────────────────
-- SEED SCORES for all 42 new skills
-- ─────────────────────────────────────────────
...
-- ─────────────────────────────────────────────
-- ADD WORKFLOW MAPPINGS FOR ORIGINAL 10 SKILLS
-- (fill gaps — some original skills were never mapped)
-- ─────────────────────────────────────────────
INSERT INTO skill_workflows (skill_id, workflow_id)
SELECT s.id, w.id FROM (
  VALUES
...
-- ─────────────────────────────────────────────
-- ADD VERTICAL MAPPINGS FOR ORIGINAL 10 SKILLS
-- ─────────────────────────────────────────────
INSERT INTO skill_verticals (skill_id, vertical_id)
SELECT s.id, v.id FROM (
  VALUES
