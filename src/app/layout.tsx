...
export const metadata: Metadata = {
  title: 'NeoSkill — Agent Skill Intelligence Platform',
        ...
        <footer className="border-t border-gray-200 mt-24 py-12">
          <div className="max-w-6xl mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-gray-500">
            <div className="flex items-center gap-2">
              <span className="font-bold text-brand">NeoSkill</span>
            ...
            <div className="flex items-center gap-6">
              ...
              <a href="https://github.com/grossiweb/NeoSkill" className="hover:text-brand transition-colors">GitHub</a>
            </div>
          </div>
        </footer>
      </body>
