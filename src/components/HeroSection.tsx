...
const COMPAT_LOGOS: { name: string; icon: JSX.Element }[] = [
  { name: 'OpenRouter', icon: (
    <svg width="20" height="14" viewBox="0 0 512 512" fill="currentColor">
  ...
  { name: 'LiteLLM', icon: (
    <svg width="16" height="16" viewBox="0 0 244 244" fill="currentColor">
  ...
  { name: 'Windsurf', icon: (
    <svg width="18" height="14" viewBox="0 0 512 512" fill="currentColor">
  ...
  { name: 'Lovable', icon: (
    <svg width="15" height="16" viewBox="0 0 512 512" fill="currentColor">
  ...
  { name: 'v0', icon: (
    <svg width="16" height="14" viewBox="0 0 512 512" fill="currentColor">
